...
if __name__ == '__main__':
    ...
    dataset_dict = create_dataset_dict('data/tagged/auto_annot_training_data_final.txt')
    tokenized_datasets = dataset_dict.map(
        tokenize_and_align_tags,
        batched=True,
        remove_columns=dataset_dict['train'].column_names,
    )
    tknzr = AutoTokenizer.from_pretrained('HooshvareLab/bert-fa-zwnj-base')
    data_collator = DataCollatorForTokenClassification(tokenizer=tknzr)
